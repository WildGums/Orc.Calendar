...
Orc.Calendar is a calendar and date/time library providing calendar functionality and date/time extensions for .NET applications.
...
```
Orc.Calendar => Calendar and date/time extension methods for .NET
```
...
| `src/Orc.Calendar/Extensions/` | Yes | Date/time extension methods |
| `src/Orc.Calendar.Tests/Extensions/` | Yes | Tests for extension methods |
